...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do `BK-MF8-12` e o requisito `RNF33`.
...
Contexto de rastreabilidade: `BK-MF8-12` -> `RNF33`.
...
export function podeEmitirAlerta(tipo: TipoAlerta, prefs: PreferenciasAlertas) {
  ...
  return { bkId: 'BK-MF8-12', requisito: 'RNF33', tipo, ativo: prefs[tipo] };
}
```
