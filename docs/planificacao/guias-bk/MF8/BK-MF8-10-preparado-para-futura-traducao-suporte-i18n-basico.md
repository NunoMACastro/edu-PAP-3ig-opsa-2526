# BK-MF8-10 - Preparado para futura tradução (suporte i18n básico).
...
- `guia_path`: `docs/planificacao/guias-bk/MF8/BK-MF8-10-preparado-para-futura-traducao-suporte-i18n-basico.md`
- `last_updated`: `2026-04-13`

## Contexto do BK
- Entrega alvo: implementar `Preparado para futura tradução (suporte i18n básico).` com rastreabilidade direta ao requisito `RNF39`.
...
- [ ] Sei mostrar onde esta o requisito `RNF39` no sistema.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do BK-MF8-10 e o requisito `RNF39`.
2. Verificar pre-condicoes tecnicas (-) e validar ambiente local antes de implementar.
3. Definir contrato de entrada/saida do fluxo principal para `Preparado para futura tradução (suporte i18n básico).`.
...
// BK BK-MF8-10: usar estas funcoes em listagens e detalhes
```
