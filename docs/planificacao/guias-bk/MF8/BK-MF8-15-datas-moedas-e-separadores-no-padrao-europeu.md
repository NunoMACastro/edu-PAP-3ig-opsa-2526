...
- Intenção pedagógica da macro `MF8`: Preparar operacao final, observabilidade, UI, testes finais e fecho para defesa PAP.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do `BK-MF8-15` e o requisito `RNF36`.
...
Contexto de rastreabilidade: `BK-MF8-15` -> `RNF36`.
...
// BK BK-MF8-15: usar estas funcoes em listagens e detalhes
```
...
- `2026-06-29`: handoff atualizado para `BK-MF8-16` após reforço de testes finais na MF8.
