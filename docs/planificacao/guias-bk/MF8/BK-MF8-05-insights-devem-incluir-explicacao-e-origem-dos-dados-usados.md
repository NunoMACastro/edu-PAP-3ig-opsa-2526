# BK-MF8-05 - Insights devem incluir explicação e origem dos dados usados.
...
- `guia_path`: `docs/planificacao/guias-bk/MF8/BK-MF8-05-insights-devem-incluir-explicacao-e-origem-dos-dados-usados.md`
- `last_updated`: `2026-04-17`

## Contexto do BK
- Entrega alvo: implementar `Insights devem incluir explicação e origem dos dados usados.` com rastreabilidade direta ao requisito `RNF33`.
- Foco tecnico da macro: operacao final, i18n e fecho para defesa PAP.
- Regra de governanca: nao alterar IDs nem contratos de dados (`bk_id/mf/sprint/owner/rf_rnf/deps/guia_path/core_or_reforco`).

## Bloco pedagogico
### Objetivo
Executar `Insights devem incluir explicação e origem dos dados usados.` com autonomia técnica, garantindo cobertura do requisito `RNF33` e evidência objetiva para avaliação.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do `BK-MF8-05` e o requisito `RNF33`.
