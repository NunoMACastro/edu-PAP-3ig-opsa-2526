...
## Contexto do BK
- Entrega alvo: implementar `Insights devem incluir explicação e origem dos dados usados.` com rastreabilidade direta ao requisito `RNF34`.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do BK-MF8-05 e o requisito `RNF34`.
2. Verificar pre-condicoes tecnicas (-) e validar ambiente local antes de implementar.
3. Definir contrato de entrada/saida do fluxo principal para `Insights devem incluir explicação e origem dos dados usados.`.
