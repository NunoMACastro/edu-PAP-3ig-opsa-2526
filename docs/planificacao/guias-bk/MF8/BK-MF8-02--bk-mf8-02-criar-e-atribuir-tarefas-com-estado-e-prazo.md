# BK-MF8-02 - Criar e atribuir tarefas com estado e prazo.
...
Neste BK vamos entregar `Criar e atribuir tarefas com estado e prazo.` com resultado observável e verificável em review, alinhado com `RF55` e com os critérios de aceite definidos neste guia.
...
- Impacto funcional: este BK materializa `Criar e atribuir tarefas com estado e prazo.` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF8` com rastreabilidade para `RF55`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF8-03`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Criar e atribuir tarefas com estado e prazo.` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF8-03`.
