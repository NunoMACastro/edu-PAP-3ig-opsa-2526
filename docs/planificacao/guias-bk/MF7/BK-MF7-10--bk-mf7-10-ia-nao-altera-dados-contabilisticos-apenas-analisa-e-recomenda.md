# BK-MF7-10 - IA não altera dados contabilísticos; apenas analisa e recomenda.
...
Neste BK vamos entregar `IA não altera dados contabilísticos; apenas analisa e recomenda.` com resultado observável e verificável em review, alinhado com `RNF35` e com os critérios de aceite definidos neste guia.
...
- Impacto funcional: este BK materializa `IA não altera dados contabilísticos; apenas analisa e recomenda.` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF7` com rastreabilidade para `RNF35`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF7-11`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `IA não altera dados contabilísticos; apenas analisa e recomenda.` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF7-11`.
