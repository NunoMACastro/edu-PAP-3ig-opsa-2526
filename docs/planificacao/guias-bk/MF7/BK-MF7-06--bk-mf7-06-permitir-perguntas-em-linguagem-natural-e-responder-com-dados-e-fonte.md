# BK-MF7-06 - Permitir **perguntas em linguagem natural** e responder com dados e fonte.
...
Neste BK vamos entregar `Permitir **perguntas em linguagem natural** e responder com dados e fonte.` com resultado observável e verificável em review, alinhado com `RF51` e com os critérios de aceite definidos neste guia.
...
- Impacto funcional: este BK materializa `Permitir **perguntas em linguagem natural** e responder com dados e fonte.` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF7` com rastreabilidade para `RF51`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF7-07`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Permitir **perguntas em linguagem natural** e responder com dados e fonte.` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF7-07`.
