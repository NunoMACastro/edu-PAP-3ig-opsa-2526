# BK-MF7-08 - Mostrar **explicações e fontes** de cada insight.
...
Neste BK vamos entregar `Mostrar **explicações e fontes** de cada insight.` com resultado observável e verificável em review, alinhado com `RF53` e com os critérios de aceite definidos neste guia.
...
- Impacto funcional: este BK materializa `Mostrar **explicações e fontes** de cada insight.` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF7` com rastreabilidade para `RF53`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF7-09`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Mostrar **explicações e fontes** de cada insight.` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF7-09`.
