# BK-MF7-01 - Relatórios de vendas, compras, margens e stock.
...
- `estado`: `TODO`
- `esforço`: `M`
- `dependências`: `BK-MF3-01, BK-MF3-08, BK-MF2-06`
- `rf_rnf`: `RF46`
- `last_updated`: `2026-04-12`

## O que vamos fazer neste BK
Neste BK vamos entregar `Relatórios de vendas, compras, margens e stock.` com resultado observável e verificável em review, alinhado com `RF46` e com os critérios de aceite definidos neste guia.

A execução decorre em `Fase 3` dentro de `MF7` e respeita as dependências `BK-MF3-01, BK-MF3-08, BK-MF2-06`. Qualquer detalhe técnico não especificado nesta fase fica `a definir no BK dependente`.

## Porque isto é importante
- Impacto funcional: este BK materializa `Relatórios de vendas, compras, margens e stock.` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF7` com rastreabilidade para `RF46`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF7-02`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Relatórios de vendas, compras, margens e stock.` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF7-02`.
