# BK-MF7-09 - Backend modular por domínio (vendas, compras, inventário, bancos, contabilidade, IA).
...
- `guia_path`: `docs/planificacao/guias-bk/MF7/BK-MF7-09-backend-modular-por-dominio-vendas-compras-inventario-bancos-contabilidade-ia.md`
- `last_updated`: `2026-04-17`

## Contexto do BK
- Entrega alvo: implementar `Backend modular por domínio (vendas, compras, inventário, bancos, contabilidade, IA).` com rastreabilidade direta ao requisito `RNF26`.
- Foco tecnico da macro: compliance, interoperabilidade e modularidade.
- Regra de governanca: nao alterar IDs nem contratos de dados (`bk_id/mf/sprint/owner/rf_rnf/deps/guia_path/core_or_reforco`).

## Bloco pedagogico
### Objetivo
Executar `Backend modular por domínio (vendas, compras, inventário, bancos, contabilidade, IA).` com autonomia técnica, garantindo cobertura do requisito `RNF26` e evidência objetiva para avaliação.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do `BK-MF7-09` e o requisito `RNF26`.
...
export function validarDocumentoFiscal(linhas: LinhaDocumento[], bkId = 'BK-MF7-09') {
