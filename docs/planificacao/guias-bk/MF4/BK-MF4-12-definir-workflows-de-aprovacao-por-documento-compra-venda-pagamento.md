# BK-MF4-12 - Definir workflows de aprovação por documento (compra, venda, pagamento).
...
- `estado`: `TODO`
- `esforco`: `S`
- `dependencias`: `BK-MF1-06, BK-MF1-10, BK-MF1-12`
- `rf_rnf`: `RF59`
- `fase_documental`: `Fase 2`
- `sprint`: `S08-S09`
- `core_or_reforco`: `Core`
- `proximo_bk`: `BK-MF5-01`
- `guia_path`: `docs/planificacao/guias-bk/MF4/BK-MF4-12-definir-workflows-de-aprovacao-por-documento-compra-venda-pagamento.md`
- `last_updated`: `2026-04-17`

## Contexto do BK
- Entrega alvo: implementar `Definir workflows de aprovação por documento (compra, venda, pagamento).` com rastreabilidade direta ao requisito `RF59`.
- Foco tecnico da macro: inteligencia operacional, alertas e governanca de operacoes.
- Regra de governanca: nao alterar IDs nem contratos de dados (`bk_id/mf/sprint/owner/rf_rnf/deps/guia_path/core_or_reforco`).

## Bloco pedagogico
### Objetivo
Executar `Definir workflows de aprovação por documento (compra, venda, pagamento).` com autonomia técnica, garantindo cobertura do requisito `RF59` e evidência objetiva para avaliação.
...
- Validar dependencias declaradas: `BK-MF1-06, BK-MF1-10, BK-MF1-12`.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do `BK-MF4-12` e o requisito `RF59`.
2. Validar dependencias técnicas (`BK-MF1-06, BK-MF1-10, BK-MF1-12`) e preparar dados de teste mínimos para `Definir workflows de aprovação por documento (compra, venda, pagamento).`.
...
export function validarDocumentoFiscal(linhas: LinhaDocumento[], bkId = 'BK-MF4-12') {
