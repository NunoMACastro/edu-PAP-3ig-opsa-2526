# BK-MF6-11 - Exportações disponíveis em CSV, Excel e PDF.
...
Neste BK vamos entregar `Exportações disponíveis em CSV, Excel e PDF.` com resultado observável e verificável em review, alinhado com `RNF23` e com os critérios de aceite definidos neste guia.
...
- Impacto funcional: este BK materializa `Exportações disponíveis em CSV, Excel e PDF.` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF6` com rastreabilidade para `RNF23`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF6-12`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Exportações disponíveis em CSV, Excel e PDF.` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF6-12`.
