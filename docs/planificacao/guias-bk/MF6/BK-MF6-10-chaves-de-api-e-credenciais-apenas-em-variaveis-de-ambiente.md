...
## Bloco pedagogico
### Objetivo
Executar `Chaves de API e credenciais apenas em variáveis de ambiente.` com rastreabilidade explicita para `RNF17` e demonstracao tecnica no contexto da sprint `S10-S11`.
