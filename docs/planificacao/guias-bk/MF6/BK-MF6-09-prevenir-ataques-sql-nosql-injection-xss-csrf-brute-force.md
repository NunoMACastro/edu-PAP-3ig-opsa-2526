...
- `guia_path`: `docs/planificacao/guias-bk/MF6/BK-MF6-09-prevenir-ataques-sql-nosql-injection-xss-csrf-brute-force.md`
- `last_updated`: `2026-04-13`

## Contexto do BK
- Entrega alvo: implementar `Prevenir ataques (SQL/NoSQL Injection, XSS, CSRF, brute force).` com rastreabilidade direta ao requisito `RNF16`.
- Foco tecnico da macro: desempenho, seguranca e robustez tecnica.
- Regra de governanca: nao alterar IDs nem contratos de dados (`bk_id/mf/sprint/owner/rf_rnf/deps/guia_path/core_or_reforco`).

## Bloco pedagogico
### Objetivo
Executar `Prevenir ataques (SQL/NoSQL Injection, XSS, CSRF, brute force).` com rastreabilidade explicita para `RNF16` e demonstracao tecnica no contexto da sprint `S10-S11`.
...
3. Definir contrato de entrada/saida do fluxo principal para `Prevenir ataques (SQL/NoSQL Injection, XSS, CSRF, brute force).`.
