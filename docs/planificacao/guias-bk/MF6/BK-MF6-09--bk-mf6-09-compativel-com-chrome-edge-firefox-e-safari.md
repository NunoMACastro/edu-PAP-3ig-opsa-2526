# BK-MF6-09 - Compatível com Chrome, Edge, Firefox e Safari.
...
Neste BK vamos entregar `Compatível com Chrome, Edge, Firefox e Safari.` com resultado observável e verificável em review, alinhado com `RNF21` e com os critérios de aceite definidos neste guia.
...
- Impacto funcional: este BK materializa `Compatível com Chrome, Edge, Firefox e Safari.` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF6` com rastreabilidade para `RNF21`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF6-10`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Compatível com Chrome, Edge, Firefox e Safari.` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF6-10`.
