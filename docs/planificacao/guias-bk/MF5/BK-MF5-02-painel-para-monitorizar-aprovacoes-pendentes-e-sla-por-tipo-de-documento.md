# BK-MF5-02 - Painel para monitorizar aprovações pendentes e SLA por tipo de documento.
...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-02-painel-para-monitorizar-aprovacoes-pendentes-e-sla-por-tipo-de-documento.md`
- `last_updated`: `2026-04-13`

## Contexto do BK
- Entrega alvo: implementar `Painel para monitorizar aprovações pendentes e SLA por tipo de documento.` com rastreabilidade direta ao requisito `RF62`.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do BK-MF5-02 e o requisito `RF62`.
2. Verificar pre-condicoes tecnicas (BK-MF4-12) e validar ambiente local antes de implementar.
3. Definir contrato de entrada/saida do fluxo principal para `Painel para monitorizar aprovações pendentes e SLA por tipo de documento.`.
...
export function validarEntradaBK(payload: Payload) {
  ...
  return { ok: true, bk: 'BK-MF5-02', payload };
}
```
