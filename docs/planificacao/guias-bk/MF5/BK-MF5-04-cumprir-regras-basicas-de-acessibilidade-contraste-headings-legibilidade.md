...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do `BK-MF5-04` e o requisito `RNF04`.
...
Contexto de rastreabilidade: `BK-MF5-04` -> `RNF04`.
...
export function validarResultado(res: Resultado) {
  ...
  return { bk: 'BK-MF5-04', validado: true };
}
```
