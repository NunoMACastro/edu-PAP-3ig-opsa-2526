# BK-MF5-03 - Agendar pagamentos/recebimentos futuros com integração às previsões de tesouraria.
...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-03-agendar-pagamentos-recebimentos-futuros-com-integracao-as-previsoes-de-tesouraria.md`
- `last_updated`: `2026-04-17`

## Contexto do BK
- Entrega alvo: implementar `Agendar pagamentos/recebimentos futuros com integração às previsões de tesouraria.` com rastreabilidade direta ao requisito `RF62`.
- Foco tecnico da macro: experiencia de utilizacao e fluxos transversais de negocio.
- Regra de governanca: nao alterar IDs nem contratos de dados (`bk_id/mf/sprint/owner/rf_rnf/deps/guia_path/core_or_reforco`).

## Bloco pedagogico
### Objetivo
Executar `Agendar pagamentos/recebimentos futuros com integração às previsões de tesouraria.` com autonomia técnica, garantindo cobertura do requisito `RF62` e evidência objetiva para avaliação.
...
- Validar dependencias declaradas: `BK-MF3-03`.
...
- [ ] Sei mostrar onde esta o requisito `RF62` no sistema.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do `BK-MF5-03` e o requisito `RF62`.
2. Validar dependencias técnicas (`BK-MF3-03`) e preparar dados de teste mínimos para `Agendar pagamentos/recebimentos futuros com integração às previsões de tesouraria.`.
...
export function validarDocumentoFiscal(linhas: LinhaDocumento[], bkId = 'BK-MF5-03') {
