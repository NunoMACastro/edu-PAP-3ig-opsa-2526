...
## Bloco pedagogico
### Objetivo
Executar `As mensagens de erro devem ser claras e indicar como resolver o problema.` com autonomia técnica, garantindo cobertura do requisito `RNF06` e evidência objetiva para avaliação.
...
2. Validar dependencias técnicas (`-`) e preparar dados de teste mínimos para `As mensagens de erro devem ser claras e indicar como resolver o problema.`.
...
export function validarResultado(res: Resultado) {
  ...
  return { bk: 'BK-MF5-10', validado: true };
}
```
