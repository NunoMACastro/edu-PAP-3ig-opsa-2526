...
3. Definir contrato de entrada/saida do fluxo principal para `Layout responsivo (desktop > tablet > mobile) com grelhas e tabelas adaptadas.`.
...
export function validarEntradaBK(payload: Payload) {
  ...
  return { ok: true, bk: 'BK-MF5-06', payload };
}
```
