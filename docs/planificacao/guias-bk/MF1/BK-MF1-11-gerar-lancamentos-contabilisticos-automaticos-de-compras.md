# BK-MF1-11 - Gerar lançamentos contabilísticos automáticos de compras.
...
- `guia_path`: `docs/planificacao/guias-bk/MF1/BK-MF1-11-gerar-lancamentos-contabilisticos-automaticos-de-compras.md`
- `last_updated`: `2026-04-17`

## Contexto do BK
- Entrega alvo: implementar `Gerar lançamentos contabilísticos automáticos de compras.` com rastreabilidade direta ao requisito `RF23`.
- Foco tecnico da macro: fluxo comercial (vendas/compras) com impacto contabilistico imediato.
- Regra de governanca: nao alterar IDs nem contratos de dados (`bk_id/mf/sprint/owner/rf_rnf/deps/guia_path/core_or_reforco`).

## Bloco pedagogico
### Objetivo
Executar `Gerar lançamentos contabilísticos automáticos de compras.` com autonomia técnica, garantindo cobertura do requisito `RF23` e evidência objetiva para avaliação.
- Intenção pedagógica da macro `MF1`: Fechar o ciclo comercial minimo com impacto contabilistico validado..

### Pre-requisitos
- Ler o requisito `RF23` e rever o contexto em `MATRIZ-CANONICA-BK.md` e `BACKLOG-MVP.md`.
- Validar dependencias declaradas: `BK-MF1-09`.
...
- [ ] Sei mostrar onde esta o requisito `RF23` no sistema.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do `BK-MF1-11` e o requisito `RF23`.
2. Validar dependencias técnicas (`BK-MF1-09`) e preparar dados de teste mínimos para `Gerar lançamentos contabilísticos automáticos de compras.`.
...
export function validarDocumentoFiscal(linhas: LinhaDocumento[], bkId = 'BK-MF1-11') {
