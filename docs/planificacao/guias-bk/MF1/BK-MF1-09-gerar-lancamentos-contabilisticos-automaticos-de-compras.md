...
## Contexto do BK
- Entrega alvo: implementar `Gerar lançamentos contabilísticos automáticos de compras.` com rastreabilidade direta ao requisito `RF21`.
- Foco tecnico da macro: fluxo comercial (vendas/compras) com impacto contabilistico imediato.
- Regra de governanca: nao alterar IDs nem contratos de dados (`bk_id/mf/sprint/owner/rf_rnf/deps/guia_path/core_or_reforco`).

## Bloco pedagogico
### Objetivo
Executar `Gerar lançamentos contabilísticos automáticos de compras.` com autonomia técnica, garantindo cobertura do requisito `RF21` e evidência objetiva para avaliação.
...
2. Validar dependencias técnicas (`BK-MF1-07`) e preparar dados de teste mínimos para `Gerar lançamentos contabilísticos automáticos de compras.`.
...
Contexto de rastreabilidade: `BK-MF1-09` -> `RF21`.
