...
## Bloco pedagogico
### Objetivo
Conseguir explicar e executar o BK `BK-MF1-04` de forma autonoma, incluindo caminho feliz, negativos e evidencia pronta para defesa.
...
- [ ] Sei mostrar onde esta o requisito `RF16` no sistema.
...
export function validarDocumentoFiscal(linhas: LinhaDocumento[], bkId = 'BK-MF1-04') {
