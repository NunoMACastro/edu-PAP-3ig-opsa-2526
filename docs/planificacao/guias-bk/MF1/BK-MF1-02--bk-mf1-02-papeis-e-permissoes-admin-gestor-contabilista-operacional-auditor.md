# BK-MF1-02 - Papéis e permissões (**Admin**, **Gestor**, **Contabilista**, **Operacional**, **Auditor**).
...
Neste BK vamos entregar `Papéis e permissões (**Admin**, **Gestor**, **Contabilista**, **Operacional**, **Auditor**).` com resultado observável e verificável em review, alinhado com `RF02` e com os critérios de aceite definidos neste guia.

A execução decorre em `Fase 1` dentro de `MF1` e respeita as dependências `BK-MF1-01`. Qualquer detalhe técnico não especificado nesta fase fica `a definir no BK dependente`.

## Porque isto é importante
- Impacto funcional: este BK materializa `Papéis e permissões (**Admin**, **Gestor**, **Contabilista**, **Operacional**, **Auditor**).` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF1` com rastreabilidade para `RF02`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF1-03`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Papéis e permissões (**Admin**, **Gestor**, **Contabilista**, **Operacional**, **Auditor**).` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF1-03`.
