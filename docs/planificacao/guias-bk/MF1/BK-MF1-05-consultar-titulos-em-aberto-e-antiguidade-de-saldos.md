...
## Bloco pedagogico
### Objetivo
Executar `Consultar títulos em aberto e antiguidade de saldos.` com rastreabilidade explicita para `RF17` e demonstracao tecnica no contexto da sprint `S03-S04`.
