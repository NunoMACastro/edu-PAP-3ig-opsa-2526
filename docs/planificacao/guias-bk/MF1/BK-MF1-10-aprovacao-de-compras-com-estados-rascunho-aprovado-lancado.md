...
## Contexto do BK
- Entrega alvo: implementar `Aprovação de compras com estados “Rascunho → Aprovado → Lançado”.` com rastreabilidade direta ao requisito `RF22`.
- Foco tecnico da macro: fluxo comercial (vendas/compras) com impacto contabilistico imediato.
- Regra de governanca: nao alterar IDs nem contratos de dados (`bk_id/mf/sprint/owner/rf_rnf/deps/guia_path/core_or_reforco`).

## Bloco pedagogico
### Objetivo
Executar `Aprovação de compras com estados “Rascunho → Aprovado → Lançado”.` com autonomia técnica, garantindo cobertura do requisito `RF22` e evidência objetiva para avaliação.
...
2. Validar dependencias técnicas (`-`) e preparar dados de teste mínimos para `Aprovação de compras com estados “Rascunho → Aprovado → Lançado”.`.
...
Contexto de rastreabilidade: `BK-MF1-10` -> `RF22`.
