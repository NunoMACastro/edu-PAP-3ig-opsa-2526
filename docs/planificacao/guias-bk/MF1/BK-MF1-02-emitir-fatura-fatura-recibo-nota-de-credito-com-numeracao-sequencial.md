...
## Bloco pedagogico
### Objetivo
Executar `Emitir Fatura, Fatura-Recibo, Nota de Crédito, com numeração sequencial.` com rastreabilidade explicita para `RF14` e demonstracao tecnica no contexto da sprint `S03-S04`.

### Pre-requisitos
- Ler o requisito `RF14` e rever o contexto em `MATRIZ-CANONICA-BK.md` e `BACKLOG-MVP.md`.
- Validar dependencias declaradas: `BK-MF0-09, BK-MF0-11, BK-MF1-01`.
...
- [ ] Sei mostrar onde esta o requisito `RF14` no sistema.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do BK-MF1-02 e o requisito `RF14`.
2. Verificar pre-condicoes tecnicas (BK-MF0-09, BK-MF0-11, BK-MF1-01) e validar ambiente local antes de implementar.
3. Definir contrato de entrada/saida do fluxo principal para `Emitir Fatura, Fatura-Recibo, Nota de Crédito, com numeração sequencial.`.
...
export function validarDocumentoFiscal(linhas: LinhaDocumento[], bkId = 'BK-MF1-02') {
