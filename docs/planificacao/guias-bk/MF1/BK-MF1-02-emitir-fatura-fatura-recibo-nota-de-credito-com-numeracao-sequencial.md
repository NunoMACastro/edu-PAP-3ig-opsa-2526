...
## Bloco pedagogico
### Objetivo
Executar `Emitir Fatura, Fatura-Recibo, Nota de Crédito, com numeração sequencial.` com autonomia técnica, garantindo cobertura do requisito `RF14` e evidência objetiva para avaliação.
...
2. Validar dependencias técnicas (`BK-MF0-09, BK-MF0-11, BK-MF1-01`) e preparar dados de teste mínimos para `Emitir Fatura, Fatura-Recibo, Nota de Crédito, com numeração sequencial.`.
