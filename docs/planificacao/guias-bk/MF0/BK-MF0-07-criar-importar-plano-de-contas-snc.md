...
## Bloco pedagogico
### Objetivo
Executar `Criar/importar plano de contas (SNC).` com rastreabilidade explicita para `RF07` e demonstracao tecnica no contexto da sprint `S01-S02`.
...
3. Definir contrato de entrada/saida do fluxo principal para `Criar/importar plano de contas (SNC).`.
