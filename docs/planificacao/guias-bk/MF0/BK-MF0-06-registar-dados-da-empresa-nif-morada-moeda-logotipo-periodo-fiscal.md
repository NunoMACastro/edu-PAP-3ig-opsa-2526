...
3. Definir contrato de entrada/saida do fluxo principal para `Registar dados da empresa (NIF, morada, moeda, logótipo, período fiscal).`.
...
export function validarEntradaBK(payload: Payload) {
  ...
  return { ok: true, bk: 'BK-MF0-06', payload };
}
```
