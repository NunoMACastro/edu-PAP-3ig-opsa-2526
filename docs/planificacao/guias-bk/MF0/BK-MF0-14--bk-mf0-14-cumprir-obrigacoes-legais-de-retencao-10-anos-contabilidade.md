# BK-MF0-14 - Cumprir obrigações legais de retenção (10 anos, contabilidade).
...
Neste BK vamos entregar `Cumprir obrigações legais de retenção (10 anos, contabilidade).` com resultado observável e verificável em review, alinhado com `RNF20` e com os critérios de aceite definidos neste guia.
...
- Impacto funcional: este BK materializa `Cumprir obrigações legais de retenção (10 anos, contabilidade).` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF0` com rastreabilidade para `RNF20`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF0-15`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Cumprir obrigações legais de retenção (10 anos, contabilidade).` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF0-15`.
