...
## Contexto do BK
- Entrega alvo: implementar `Criar e editar lançamentos manuais (com anexos).` com rastreabilidade direta ao requisito `RF28`.
- Foco tecnico da macro: stock, analitica e contabilidade operacional.
- Regra de governanca: nao alterar IDs nem contratos de dados (`bk_id/mf/sprint/owner/rf_rnf/deps/guia_path/core_or_reforco`).

## Bloco pedagogico
### Objetivo
Executar `Criar e editar lançamentos manuais (com anexos).` com autonomia técnica, garantindo cobertura do requisito `RF28` e evidência objetiva para avaliação.
- Intenção pedagógica da macro `MF2`: Garantir integridade de inventario e contabilidade operacional por evento..

### Pre-requisitos
- Ler o requisito `RF28` e rever o contexto em `MATRIZ-CANONICA-BK.md` e `BACKLOG-MVP.md`.
...
- [ ] Sei mostrar onde esta o requisito `RF28` no sistema.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do `BK-MF2-06` e o requisito `RF28`.
2. Validar dependencias técnicas (`BK-MF0-07`) e preparar dados de teste mínimos para `Criar e editar lançamentos manuais (com anexos).`.
...
-- Validacoes de consistencia específicas do requisito RF28
