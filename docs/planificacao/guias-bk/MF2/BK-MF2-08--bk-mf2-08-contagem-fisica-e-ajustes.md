# BK-MF2-08 - Contagem física e ajustes.
...
Neste BK vamos entregar `Contagem física e ajustes.` com resultado observável e verificável em review, alinhado com `RF29` e com os critérios de aceite definidos neste guia.
...
- Impacto funcional: este BK materializa `Contagem física e ajustes.` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF2` com rastreabilidade para `RF29`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF2-09`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Contagem física e ajustes.` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF2-09`.
