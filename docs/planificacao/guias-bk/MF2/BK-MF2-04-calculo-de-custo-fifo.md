# BK-MF2-04 - Cálculo de custo (FIFO).
...
- `guia_path`: `docs/planificacao/guias-bk/MF2/BK-MF2-04-calculo-de-custo-fifo.md`
- `last_updated`: `2026-04-17`

## Contexto do BK
- Entrega alvo: implementar `Cálculo de custo (FIFO).` com rastreabilidade direta ao requisito `RF28`.
- Foco tecnico da macro: stock, analitica e contabilidade operacional.
- Regra de governanca: nao alterar IDs nem contratos de dados (`bk_id/mf/sprint/owner/rf_rnf/deps/guia_path/core_or_reforco`).

## Bloco pedagogico
### Objetivo
Executar `Cálculo de custo (FIFO).` com autonomia técnica, garantindo cobertura do requisito `RF28` e evidência objetiva para avaliação.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do `BK-MF2-04` e o requisito `RF28`.
2. Validar dependencias técnicas (`BK-MF2-03`) e preparar dados de teste mínimos para `Cálculo de custo (FIFO).`.
