...
## Bloco pedagogico
### Objetivo
Executar `Relatórios e filtros por centro de custo/segmento.` com autonomia técnica, garantindo cobertura do requisito `RF33` e evidência objetiva para avaliação.
...
2. Validar dependencias técnicas (`BK-MF2-08`) e preparar dados de teste mínimos para `Relatórios e filtros por centro de custo/segmento.`.
...
-- Validacoes de consistencia específicas do requisito RF33
