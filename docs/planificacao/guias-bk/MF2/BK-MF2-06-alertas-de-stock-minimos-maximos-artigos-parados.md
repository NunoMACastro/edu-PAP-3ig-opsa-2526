...
## Bloco pedagogico
### Objetivo
Executar `Alertas de stock (mínimos, máximos, artigos parados).` com autonomia técnica, garantindo cobertura do requisito `RF30` e evidência objetiva para avaliação.
...
2. Validar dependencias técnicas (`BK-MF2-03`) e preparar dados de teste mínimos para `Alertas de stock (mínimos, máximos, artigos parados).`.
