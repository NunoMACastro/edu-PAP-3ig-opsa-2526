...
## Bloco pedagogico
### Objetivo
Executar `Gerar Demonstração de Resultados e Balanço.` com autonomia técnica, garantindo cobertura do requisito `RF36` e evidência objetiva para avaliação.
...
2. Validar dependencias técnicas (`BK-MF2-11`) e preparar dados de teste mínimos para `Gerar Demonstração de Resultados e Balanço.`.
...
-- Validacoes de consistencia específicas do requisito RF36
