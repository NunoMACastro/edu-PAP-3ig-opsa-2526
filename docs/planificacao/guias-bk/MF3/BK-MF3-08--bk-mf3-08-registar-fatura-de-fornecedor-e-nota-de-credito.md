# BK-MF3-08 - Registar **Fatura de Fornecedor** e **Nota de Crédito**.
...
- `estado`: `TODO`
- `esforço`: `M`
- `dependências`: `BK-MF2-02, BK-MF2-03, BK-MF2-05`
- `rf_rnf`: `RF21`
- `last_updated`: `2026-04-12`

## O que vamos fazer neste BK
Neste BK vamos entregar `Registar **Fatura de Fornecedor** e **Nota de Crédito**.` com resultado observável e verificável em review, alinhado com `RF21` e com os critérios de aceite definidos neste guia.

A execução decorre em `Fase 2` dentro de `MF3` e respeita as dependências `BK-MF2-02, BK-MF2-03, BK-MF2-05`. Qualquer detalhe técnico não especificado nesta fase fica `a definir no BK dependente`.

## Porque isto é importante
- Impacto funcional: este BK materializa `Registar **Fatura de Fornecedor** e **Nota de Crédito**.` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF3` com rastreabilidade para `RF21`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF3-09`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Registar **Fatura de Fornecedor** e **Nota de Crédito**.` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF3-09`.
