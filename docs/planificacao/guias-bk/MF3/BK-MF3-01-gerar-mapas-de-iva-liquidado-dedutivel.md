...
2. Verificar pre-condicoes tecnicas (BK-MF1-04, BK-MF1-11) e validar ambiente local antes de implementar.
3. Definir contrato de entrada/saida do fluxo principal para `Gerar Mapas de IVA (liquidado/dedutível).`.
...
export function validarDocumentoFiscal(linhas: LinhaDocumento[], bkId = 'BK-MF3-01') {
