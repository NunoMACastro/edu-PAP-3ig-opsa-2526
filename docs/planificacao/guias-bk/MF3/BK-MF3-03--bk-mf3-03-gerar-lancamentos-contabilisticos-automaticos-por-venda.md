# BK-MF3-03 - Gerar **lançamentos contabilísticos automáticos** por venda.
...
Neste BK vamos entregar `Gerar **lançamentos contabilísticos automáticos** por venda.` com resultado observável e verificável em review, alinhado com `RF16` e com os critérios de aceite definidos neste guia.
...
- Impacto funcional: este BK materializa `Gerar **lançamentos contabilísticos automáticos** por venda.` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF3` com rastreabilidade para `RF16`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF3-04`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Gerar **lançamentos contabilísticos automáticos** por venda.` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF3-04`.
