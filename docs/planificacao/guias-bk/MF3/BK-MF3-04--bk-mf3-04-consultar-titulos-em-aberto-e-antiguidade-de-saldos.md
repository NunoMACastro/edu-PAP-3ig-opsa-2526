# BK-MF3-04 - Consultar **títulos em aberto** e antiguidade de saldos.
...
Neste BK vamos entregar `Consultar **títulos em aberto** e antiguidade de saldos.` com resultado observável e verificável em review, alinhado com `RF17` e com os critérios de aceite definidos neste guia.
...
- Impacto funcional: este BK materializa `Consultar **títulos em aberto** e antiguidade de saldos.` no produto OPSA.
- Impacto técnico/arquitetural: consolida capacidades da macro `MF3` com rastreabilidade para `RF17`.
- Impacto na sequência: desbloqueia a progressão para `BK-MF3-05`.
- Risco de execução incorreta: falhas aqui propagam inconsistências para backlog, validação e defesa.

## O que entra (scope)
- Definir tarefas executáveis para `Consultar **títulos em aberto** e antiguidade de saldos.` com owner e apoio claros.
...
- Trabalho de BKs seguintes, incluindo `BK-MF3-05`.
