...
## Contexto do BK
- Entrega alvo: implementar `Criar contas bancárias/caixa e respetivos saldos.` com rastreabilidade direta ao requisito `RF32`.
- Foco tecnico da macro: tesouraria, integracoes e relatorio funcional.
- Regra de governanca: nao alterar IDs nem contratos de dados (`bk_id/mf/sprint/owner/rf_rnf/deps/guia_path/core_or_reforco`).

## Bloco pedagogico
### Objetivo
Executar `Criar contas bancárias/caixa e respetivos saldos.` com autonomia técnica, garantindo cobertura do requisito `RF32` e evidência objetiva para avaliação.
...
### Passos
1. Confirmar no `BACKLOG-MVP` e na `MATRIZ-CANONICA-BK` o escopo do `BK-MF3-02` e o requisito `RF32`.
...
Contexto de rastreabilidade: `BK-MF3-02` -> `RF32`.
