...
## Objetivo
Padronizar avaliacao por sprint com criterios fixos de qualidade e controlo de carga real.

## Contrato do scorecard
Campos obrigatorios por sprint:
`cobertura`, `coerencia`, `pedagogia_operacao`, `adequacao_12o`, `governanca`, `carga_planeada_u`, `carga_real_u`, `desvio_u`, `risco_semaforo`, `acao_corretiva`.
...
| Pedagogia+operacao executavel | 25 |
| Adequacao ao 12o | 20 |
| Governanca/avaliacao | 10 |
| **Total** | **100** |

## Scorecard por sprint
| sprint | cobertura | coerencia | pedagogia_operacao | adequacao_12o | governanca | carga_planeada_u | carga_real_u | desvio_u | risco_semaforo | acao_corretiva |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| S01 | - | - | - | - | - | 12 | - | - | Verde | - |
| S02 | - | - | - | - | - | 12 | - | - | Verde | - |
| S03 | - | - | - | - | - | 13 | - | - | Verde | - |
