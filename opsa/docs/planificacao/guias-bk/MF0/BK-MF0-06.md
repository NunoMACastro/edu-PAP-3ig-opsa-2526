# BK-MF0-06 - Registar dados da empresa (NIF, morada, moeda, logotipo, periodo fiscal).
...
- `guia_path`: `docs/planificacao/guias-bk/MF0/BK-MF0-06.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF06` associado a `Registar dados da empresa (NIF, morada, moeda, logotipo, periodo fiscal).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Registar dados da empresa (NIF, morada, moeda, logotipo, periodo fiscal).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF06` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF06) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF0-06`.
