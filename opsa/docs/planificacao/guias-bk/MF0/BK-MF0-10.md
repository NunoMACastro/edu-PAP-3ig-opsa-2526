...
- `guia_path`: `docs/planificacao/guias-bk/MF0/BK-MF0-10.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF10` associado a `Criar e gerir fornecedores.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Criar e gerir fornecedores.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF10` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF10) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF0-10`.
