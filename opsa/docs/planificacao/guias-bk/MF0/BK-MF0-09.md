...
- `guia_path`: `docs/planificacao/guias-bk/MF0/BK-MF0-09.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF09` associado a `Criar e gerir clientes.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Criar e gerir clientes.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF09` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF09) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF0-09`.
