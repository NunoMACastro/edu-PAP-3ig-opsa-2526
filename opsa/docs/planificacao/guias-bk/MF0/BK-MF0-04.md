# BK-MF0-04 - Gestao de utilizadores: convite, remocao e definicao de papeis.
...
- `guia_path`: `docs/planificacao/guias-bk/MF0/BK-MF0-04.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF04` associado a `Gestao de utilizadores: convite, remocao e definicao de papeis.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Gestao de utilizadores: convite, remocao e definicao de papeis.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF04` e demonstrado em cenario real de utilizacao.
...
- Dependencias tecnicas declaradas: `BK-MF0-03`.
...
1. Ler `RF/RNF` do BK (RF04) e confirmar contexto tecnico antes de tocar no codigo.
2. Validar dependencias declaradas (BK-MF0-03) e confirmar pre-condicoes em ambiente local.
3. Escrever mini-plano de implementacao (entrada, processamento, saida, erros) em 5-8 linhas.
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF0-04`.
