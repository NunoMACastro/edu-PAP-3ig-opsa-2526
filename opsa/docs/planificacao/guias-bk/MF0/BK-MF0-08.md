# BK-MF0-08 - Abrir e fechar periodos fiscais, bloqueando lancamentos apos fecho.
...
- `guia_path`: `docs/planificacao/guias-bk/MF0/BK-MF0-08.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF08` associado a `Abrir e fechar periodos fiscais, bloqueando lancamentos apos fecho.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Abrir e fechar periodos fiscais, bloqueando lancamentos apos fecho.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF08` e demonstrado em cenario real de utilizacao.
...
- Dependencias tecnicas declaradas: `BK-MF0-07`.
...
1. Ler `RF/RNF` do BK (RF08) e confirmar contexto tecnico antes de tocar no codigo.
2. Validar dependencias declaradas (BK-MF0-07) e confirmar pre-condicoes em ambiente local.
3. Escrever mini-plano de implementacao (entrada, processamento, saida, erros) em 5-8 linhas.
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF0-08`.
