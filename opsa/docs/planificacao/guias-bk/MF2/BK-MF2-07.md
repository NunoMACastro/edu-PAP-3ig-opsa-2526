# BK-MF2-07 - Configurar centros de custo / segmentos analiticos.
...
- `guia_path`: `docs/planificacao/guias-bk/MF2/BK-MF2-07.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF31` associado a `Configurar centros de custo / segmentos analiticos.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Configurar centros de custo / segmentos analiticos.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF31` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF31) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF2-07`.
