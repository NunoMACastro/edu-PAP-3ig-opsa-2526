# BK-MF2-01 - Configurar limites e papeis para aprovacoes (por fornecedor/valor).
...
- `guia_path`: `docs/planificacao/guias-bk/MF2/BK-MF2-01.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF25` associado a `Configurar limites e papeis para aprovacoes (por fornecedor/valor).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Configurar limites e papeis para aprovacoes (por fornecedor/valor).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF25` e demonstrado em cenario real de utilizacao.
...
- Dependencias tecnicas declaradas: `BK-MF1-12`.
...
1. Ler `RF/RNF` do BK (RF25) e confirmar contexto tecnico antes de tocar no codigo.
2. Validar dependencias declaradas (BK-MF1-12) e confirmar pre-condicoes em ambiente local.
3. Escrever mini-plano de implementacao (entrada, processamento, saida, erros) em 5-8 linhas.
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF2-01`.
