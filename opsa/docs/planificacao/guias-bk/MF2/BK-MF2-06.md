# BK-MF2-06 - Alertas de stock (minimos, maximos, artigos parados).
...
- `guia_path`: `docs/planificacao/guias-bk/MF2/BK-MF2-06.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF30` associado a `Alertas de stock (minimos, maximos, artigos parados).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Alertas de stock (minimos, maximos, artigos parados).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF30` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF30) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF2-06`.
