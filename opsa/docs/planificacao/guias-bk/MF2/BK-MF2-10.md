# BK-MF2-10 - Criar e editar lancamentos manuais (com anexos).
...
- `guia_path`: `docs/planificacao/guias-bk/MF2/BK-MF2-10.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF34` associado a `Criar e editar lancamentos manuais (com anexos).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Criar e editar lancamentos manuais (com anexos).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF34` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF34) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF2-10`.
