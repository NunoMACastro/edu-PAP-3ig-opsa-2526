# BK-MF2-04 - Calculo de custo (FIFO).
...
- `guia_path`: `docs/planificacao/guias-bk/MF2/BK-MF2-04.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF28` associado a `Calculo de custo (FIFO).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Calculo de custo (FIFO).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF28` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF28) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF2-04`.
