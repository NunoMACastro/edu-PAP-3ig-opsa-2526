# BK-MF2-12 - Gerar Demonstracao de Resultados e Balanco.
...
- `guia_path`: `docs/planificacao/guias-bk/MF2/BK-MF2-12.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF36` associado a `Gerar Demonstracao de Resultados e Balanco.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Gerar Demonstracao de Resultados e Balanco.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF36` e demonstrado em cenario real de utilizacao.
...
- Dependencias tecnicas declaradas: `BK-MF2-11`.
...
1. Ler `RF/RNF` do BK (RF36) e confirmar contexto tecnico antes de tocar no codigo.
2. Validar dependencias declaradas (BK-MF2-11) e confirmar pre-condicoes em ambiente local.
3. Escrever mini-plano de implementacao (entrada, processamento, saida, erros) em 5-8 linhas.
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF2-12`.
