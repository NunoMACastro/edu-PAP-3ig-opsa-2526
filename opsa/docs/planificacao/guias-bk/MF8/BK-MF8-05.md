# BK-MF8-05 - Insights devem incluir explicacao e origem dos dados usados.
...
- `guia_path`: `docs/planificacao/guias-bk/MF8/BK-MF8-05.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF34` associado a `Insights devem incluir explicacao e origem dos dados usados.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Insights devem incluir explicacao e origem dos dados usados.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF34` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF34) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF8-05`.
