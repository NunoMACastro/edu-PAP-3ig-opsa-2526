# BK-MF8-08 - IA deve evitar enviesamentos e sugerir acoes baseadas em dados reais.
...
- `guia_path`: `docs/planificacao/guias-bk/MF8/BK-MF8-08.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF37` associado a `IA deve evitar enviesamentos e sugerir acoes baseadas em dados reais.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `IA deve evitar enviesamentos e sugerir acoes baseadas em dados reais.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF37` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF37) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF8-08`.
