# BK-MF8-07 - Alertas configuraveis (ativar/desativar tipos).
...
- `guia_path`: `docs/planificacao/guias-bk/MF8/BK-MF8-07.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF36` associado a `Alertas configuraveis (ativar/desativar tipos).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Alertas configuraveis (ativar/desativar tipos).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF36` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF36) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF8-07`.
