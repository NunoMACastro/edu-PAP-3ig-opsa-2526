# BK-MF8-11 - Datas, moedas e separadores no padrao europeu.
...
- `proximo_bk`: `-`
- `guia_path`: `docs/planificacao/guias-bk/MF8/BK-MF8-11.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF40` associado a `Datas, moedas e separadores no padrao europeu.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Datas, moedas e separadores no padrao europeu.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF40` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF40) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF8-11`.
