# BK-MF8-10 - Preparado para futura traducao (suporte i18n basico).
...
- `guia_path`: `docs/planificacao/guias-bk/MF8/BK-MF8-10.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF39` associado a `Preparado para futura traducao (suporte i18n basico).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Preparado para futura traducao (suporte i18n basico).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF39` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF39) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF8-10`.
