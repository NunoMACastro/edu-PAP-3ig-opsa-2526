# BK-MF4-05 - Mostrar explicacoes e fontes de cada insight.
...
- `guia_path`: `docs/planificacao/guias-bk/MF4/BK-MF4-05.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF53` associado a `Mostrar explicacoes e fontes de cada insight.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Mostrar explicacoes e fontes de cada insight.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF53` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF53) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF4-05`.
