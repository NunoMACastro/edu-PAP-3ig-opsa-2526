...
- `estado`: `TODO`
- `esforco`: `S`
- `dependencias`: `BK-MF3-04, BK-MF2-06`
- `rf_rnf`: `RF52`
- `fase_documental`: `Fase 2`
- `sprint`: `S08-S09`
- `core_or_reforco`: `Core`
- `proximo_bk`: `BK-MF4-05`
- `guia_path`: `docs/planificacao/guias-bk/MF4/BK-MF4-04.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF52` associado a `Emitir alertas inteligentes (cashflow, desvios, ruturas).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Emitir alertas inteligentes (cashflow, desvios, ruturas).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF52` e demonstrado em cenario real de utilizacao.
...
- Dependencias tecnicas declaradas: `BK-MF3-04, BK-MF2-06`.
...
1. Ler `RF/RNF` do BK (RF52) e confirmar contexto tecnico antes de tocar no codigo.
2. Validar dependencias declaradas (BK-MF3-04, BK-MF2-06) e confirmar pre-condicoes em ambiente local.
3. Escrever mini-plano de implementacao (entrada, processamento, saida, erros) em 5-8 linhas.
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF4-04`.
