...
- `guia_path`: `docs/planificacao/guias-bk/MF4/BK-MF4-03.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF51` associado a `Permitir perguntas em linguagem natural e responder com dados e fonte.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Permitir perguntas em linguagem natural e responder com dados e fonte.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF51` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF51) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF4-03`.
