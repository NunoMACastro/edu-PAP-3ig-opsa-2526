# BK-MF4-11 - Permitir reabertura de periodos apenas com registo de motivo.
...
- `guia_path`: `docs/planificacao/guias-bk/MF4/BK-MF4-11.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF59` associado a `Permitir reabertura de periodos apenas com registo de motivo.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Permitir reabertura de periodos apenas com registo de motivo.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF59` e demonstrado em cenario real de utilizacao.
...
- Dependencias tecnicas declaradas: `BK-MF0-08`.
...
1. Ler `RF/RNF` do BK (RF59) e confirmar contexto tecnico antes de tocar no codigo.
2. Validar dependencias declaradas (BK-MF0-08) e confirmar pre-condicoes em ambiente local.
3. Escrever mini-plano de implementacao (entrada, processamento, saida, erros) em 5-8 linhas.
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF4-11`.
