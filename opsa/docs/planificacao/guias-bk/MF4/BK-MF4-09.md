# BK-MF4-09 - Registar auditoria: quem, quando, o que, em operacoes sensiveis.
...
- `guia_path`: `docs/planificacao/guias-bk/MF4/BK-MF4-09.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF57` associado a `Registar auditoria: quem, quando, o que, em operacoes sensiveis.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Registar auditoria: quem, quando, o que, em operacoes sensiveis.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF57` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF57) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF4-09`.
