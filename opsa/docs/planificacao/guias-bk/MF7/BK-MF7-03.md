# BK-MF7-03 - Compativel com Chrome, Edge, Firefox e Safari.
...
- `guia_path`: `docs/planificacao/guias-bk/MF7/BK-MF7-03.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF21` associado a `Compativel com Chrome, Edge, Firefox e Safari.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Compativel com Chrome, Edge, Firefox e Safari.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF21` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF21) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF7-03`.
