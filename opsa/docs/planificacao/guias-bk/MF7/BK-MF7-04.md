# BK-MF7-04 - Integracao com servicos de email (recuperacao de password, alertas).
...
- `guia_path`: `docs/planificacao/guias-bk/MF7/BK-MF7-04.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF22` associado a `Integracao com servicos de email (recuperacao de password, alertas).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Integracao com servicos de email (recuperacao de password, alertas).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF22` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF22) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF7-04`.
