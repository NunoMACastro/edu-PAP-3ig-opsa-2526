# BK-MF7-06 - Importacoes CSV/Excel com validacao e logs de erro.
...
- `guia_path`: `docs/planificacao/guias-bk/MF7/BK-MF7-06.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF24` associado a `Importacoes CSV/Excel com validacao e logs de erro.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Importacoes CSV/Excel com validacao e logs de erro.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF24` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF24) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF7-06`.
