# BK-MF7-02 - Cumprir obrigacoes legais de retencao (10 anos, contabilidade).
...
- `guia_path`: `docs/planificacao/guias-bk/MF7/BK-MF7-02.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF20` associado a `Cumprir obrigacoes legais de retencao (10 anos, contabilidade).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Cumprir obrigacoes legais de retencao (10 anos, contabilidade).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF20` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF20) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF7-02`.
