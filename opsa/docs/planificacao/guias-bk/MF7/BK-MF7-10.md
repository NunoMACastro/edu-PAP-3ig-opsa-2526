# BK-MF7-10 - Frontend modular com componentes reutilizaveis.
...
- `guia_path`: `docs/planificacao/guias-bk/MF7/BK-MF7-10.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF28` associado a `Frontend modular com componentes reutilizaveis.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Frontend modular com componentes reutilizaveis.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF28` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF28) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF7-10`.
