# BK-MF7-11 - Testes automatizados para modulos criticos (faturacao, IVA, balancetes, reconciliacao).
...
- `guia_path`: `docs/planificacao/guias-bk/MF7/BK-MF7-11.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF29` associado a `Testes automatizados para modulos criticos (faturacao, IVA, balancetes, reconciliacao).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Testes automatizados para modulos criticos (faturacao, IVA, balancetes, reconciliacao).` desbloqueia valor direto no produto OPSA.
- Impacto tecnico: reforca a dimensao `Qualidade & Testes` sob o criterio `Estrategia de testes automatizados e criterios de aceite mensuraveis por BK.`.
...
- Onde tocar no projeto: Estrategia de testes automatizados, cenarios de regressao e criterios de aceite mensuraveis.
...
- O requisito `RNF29` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF29) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF7-11`.
5. Implementar testes automatizados do caminho feliz e dos casos limite com criterio de aprovacao.
...
### Negativos
- [ ] Teste de regressao critica falha e impede declaracao de pronto.
- [ ] Cenario de erro conhecido fica coberto por teste automatizado.
- [ ] Execucao flakey e estabilizada antes do fecho do BK.
...
## Criterios de aceite
- `Suite minima de testes cobre caminho feliz e negativos criticos do BK.`
- `Criterios de aceite sao mensuraveis e executados antes do fecho.`
- `Nao existem falhas criticas abertas associadas ao requisito do BK.`
