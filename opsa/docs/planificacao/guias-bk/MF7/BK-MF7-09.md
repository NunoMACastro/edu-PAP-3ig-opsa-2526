# BK-MF7-09 - Backend modular por dominio (vendas, compras, inventario, bancos, contabilidade, IA).
...
- `guia_path`: `docs/planificacao/guias-bk/MF7/BK-MF7-09.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF27` associado a `Backend modular por dominio (vendas, compras, inventario, bancos, contabilidade, IA).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Backend modular por dominio (vendas, compras, inventario, bancos, contabilidade, IA).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF27` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF27) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF7-09`.
