# BK-MF7-05 - Exportacoes disponiveis em CSV, Excel e PDF.
...
- `guia_path`: `docs/planificacao/guias-bk/MF7/BK-MF7-05.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF23` associado a `Exportacoes disponiveis em CSV, Excel e PDF.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Exportacoes disponiveis em CSV, Excel e PDF.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF23` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF23) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF7-05`.
