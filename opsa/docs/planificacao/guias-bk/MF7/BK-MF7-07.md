# BK-MF7-07 - Geracao de SAF-T conforme especificacoes legais (PT).
...
- `guia_path`: `docs/planificacao/guias-bk/MF7/BK-MF7-07.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF25` associado a `Geracao de SAF-T conforme especificacoes legais (PT).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Geracao de SAF-T conforme especificacoes legais (PT).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF25` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF25) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF7-07`.
