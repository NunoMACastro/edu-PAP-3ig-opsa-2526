# BK-MF7-01 - Backups automaticos diarios com restauracao possivel.
...
- `guia_path`: `docs/planificacao/guias-bk/MF7/BK-MF7-01.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF19` associado a `Backups automaticos diarios com restauracao possivel.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Backups automaticos diarios com restauracao possivel.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF19` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF19) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF7-01`.
