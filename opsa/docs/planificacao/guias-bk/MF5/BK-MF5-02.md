# BK-MF5-02 - Painel para monitorizar aprovacoes pendentes e SLA por tipo de documento.
...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-02.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF62` associado a `Painel para monitorizar aprovacoes pendentes e SLA por tipo de documento.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Painel para monitorizar aprovacoes pendentes e SLA por tipo de documento.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF62` e demonstrado em cenario real de utilizacao.
...
- Dependencias tecnicas declaradas: `BK-MF4-12`.
...
1. Ler `RF/RNF` do BK (RF62) e confirmar contexto tecnico antes de tocar no codigo.
2. Validar dependencias declaradas (BK-MF4-12) e confirmar pre-condicoes em ambiente local.
3. Escrever mini-plano de implementacao (entrada, processamento, saida, erros) em 5-8 linhas.
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF5-02`.
