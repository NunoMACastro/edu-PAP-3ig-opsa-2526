# BK-MF5-09 - Os formularios devem validar erros antes de submissao (NIF, IBAN, datas, IVA, contas SNC).
...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-09.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF05` associado a `Os formularios devem validar erros antes de submissao (NIF, IBAN, datas, IVA, contas SNC).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Os formularios devem validar erros antes de submissao (NIF, IBAN, datas, IVA, contas SNC).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF05` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF05) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF5-09`.
