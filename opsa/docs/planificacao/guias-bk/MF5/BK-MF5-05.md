# BK-MF5-05 - Interface intuitiva, clara e consistente entre modulos (Vendas, Compras, Inventario, Contabilidade).
...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-05.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF01` associado a `Interface intuitiva, clara e consistente entre modulos (Vendas, Compras, Inventario, Contabilidade).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Interface intuitiva, clara e consistente entre modulos (Vendas, Compras, Inventario, Contabilidade).` desbloqueia valor direto no produto OPSA.
- Impacto tecnico: reforca a dimensao `Frontend (Visual)` sob o criterio `Paginas, layout, acessibilidade e consistencia visual especificados com clareza.`.
...
- Onde tocar no projeto: Paginas, componentes, design system, responsividade e acessibilidade visual da interface.
...
- O requisito `RNF01` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF01) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF5-05`.
5. Implementar layout responsivo (desktop/tablet/mobile), estados visuais e acessibilidade minima.
...
### Negativos
- [ ] Breakpoint mobile nao quebra layout critico da pagina.
- [ ] Contraste/foco insuficiente e corrigido antes da aprovacao.
- [ ] Estado vazio/erro e apresentado com hierarquia visual consistente.
...
## Criterios de aceite
- `Pagina/fluxo cumpre responsividade nos breakpoints definidos.`
- `Acessibilidade minima (foco, contraste, labels) comprovada por checklist.`
- `Estados visuais (vazio/erro/sucesso) estao consistentes com o design do projeto.`
