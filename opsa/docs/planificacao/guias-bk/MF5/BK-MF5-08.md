# BK-MF5-08 - Cumprir regras basicas de acessibilidade (contraste, headings, legibilidade).
...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-08.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF04` associado a `Cumprir regras basicas de acessibilidade (contraste, headings, legibilidade).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Cumprir regras basicas de acessibilidade (contraste, headings, legibilidade).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF04` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF04) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF5-08`.
