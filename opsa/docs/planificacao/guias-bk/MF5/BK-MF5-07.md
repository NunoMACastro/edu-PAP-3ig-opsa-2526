# BK-MF5-07 - A interface deve usar feedback imediato em todas as acoes (guardar, validar, uploads).
...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-07.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF03` associado a `A interface deve usar feedback imediato em todas as acoes (guardar, validar, uploads).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `A interface deve usar feedback imediato em todas as acoes (guardar, validar, uploads).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF03` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF03) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF5-07`.
