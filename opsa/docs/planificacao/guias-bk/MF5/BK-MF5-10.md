...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-10.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF06` associado a `As mensagens de erro devem ser claras e indicar como resolver o problema.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `As mensagens de erro devem ser claras e indicar como resolver o problema.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF06` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF06) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF5-10`.
