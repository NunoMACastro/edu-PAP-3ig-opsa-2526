# BK-MF5-01 - Configurar niveis de aprovacao com limites financeiros e escalamentos.
...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-01.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF61` associado a `Configurar niveis de aprovacao com limites financeiros e escalamentos.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Configurar niveis de aprovacao com limites financeiros e escalamentos.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF61` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF61) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF5-01`.
