# BK-MF5-06 - Layout responsivo (desktop > tablet > mobile) com grelhas e tabelas adaptadas.
...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-06.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF02` associado a `Layout responsivo (desktop > tablet > mobile) com grelhas e tabelas adaptadas.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Layout responsivo (desktop > tablet > mobile) com grelhas e tabelas adaptadas.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF02` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF02) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF5-06`.
