# BK-MF3-08 - (Opcional) Integracao com e-Fatura.
...
- `guia_path`: `docs/planificacao/guias-bk/MF3/BK-MF3-08.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF44` associado a `(Opcional) Integracao com e-Fatura.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `(Opcional) Integracao com e-Fatura.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF44` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF44) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF3-08`.
