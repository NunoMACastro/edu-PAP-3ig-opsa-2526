# BK-MF3-06 - Importar CSV/Excel de clientes, fornecedores, artigos e extratos.
...
- `guia_path`: `docs/planificacao/guias-bk/MF3/BK-MF3-06.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF42` associado a `Importar CSV/Excel de clientes, fornecedores, artigos e extratos.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Importar CSV/Excel de clientes, fornecedores, artigos e extratos.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF42` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF42) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF3-06`.
