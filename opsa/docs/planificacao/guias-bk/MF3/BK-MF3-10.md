# BK-MF3-10 - Relatorios de vendas, compras, margens e stock.
...
- `guia_path`: `docs/planificacao/guias-bk/MF3/BK-MF3-10.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF46` associado a `Relatorios de vendas, compras, margens e stock.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Relatorios de vendas, compras, margens e stock.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF46` e demonstrado em cenario real de utilizacao.
...
- Dependencias tecnicas declaradas: `BK-MF1-02, BK-MF1-09, BK-MF2-03`.
...
1. Ler `RF/RNF` do BK (RF46) e confirmar contexto tecnico antes de tocar no codigo.
2. Validar dependencias declaradas (BK-MF1-02, BK-MF1-09, BK-MF2-03) e confirmar pre-condicoes em ambiente local.
3. Escrever mini-plano de implementacao (entrada, processamento, saida, erros) em 5-8 linhas.
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF3-10`.
