# BK-MF3-09 - Mapear documentos de integracao para centros de custo.
...
- `guia_path`: `docs/planificacao/guias-bk/MF3/BK-MF3-09.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF45` associado a `Mapear documentos de integracao para centros de custo.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Mapear documentos de integracao para centros de custo.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF45` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF45) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF3-09`.
