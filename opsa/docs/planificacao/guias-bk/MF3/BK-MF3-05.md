# BK-MF3-05 - Upload de documentos com OCR (ler NIF, data, total, IVA).
...
- `guia_path`: `docs/planificacao/guias-bk/MF3/BK-MF3-05.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF41` associado a `Upload de documentos com OCR (ler NIF, data, total, IVA).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Upload de documentos com OCR (ler NIF, data, total, IVA).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF41` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF41) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF3-05`.
