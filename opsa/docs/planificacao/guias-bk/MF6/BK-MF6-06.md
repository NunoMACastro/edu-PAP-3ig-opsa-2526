# BK-MF6-06 - Toda a comunicacao deve usar HTTPS (TLS 1.2+).
...
- `guia_path`: `docs/planificacao/guias-bk/MF6/BK-MF6-06.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF13` associado a `Toda a comunicacao deve usar HTTPS (TLS 1.2+).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Toda a comunicacao deve usar HTTPS (TLS 1.2+).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF13` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF13) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF6-06`.
