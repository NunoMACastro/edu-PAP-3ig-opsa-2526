# BK-MF6-08 - Sessoes com cookies HttpOnly + Secure + SameSite.
...
- `guia_path`: `docs/planificacao/guias-bk/MF6/BK-MF6-08.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF15` associado a `Sessoes com cookies HttpOnly + Secure + SameSite.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Sessoes com cookies HttpOnly + Secure + SameSite.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF15` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF15) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF6-08`.
