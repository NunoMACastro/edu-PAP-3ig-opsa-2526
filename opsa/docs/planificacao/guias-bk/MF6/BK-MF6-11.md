# BK-MF6-11 - Auditoria obrigatoria em operacoes sensiveis.
...
- `guia_path`: `docs/planificacao/guias-bk/MF6/BK-MF6-11.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF18` associado a `Auditoria obrigatoria em operacoes sensiveis.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Auditoria obrigatoria em operacoes sensiveis.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF18` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF18) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF6-11`.
