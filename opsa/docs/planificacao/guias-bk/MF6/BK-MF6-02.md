# BK-MF6-02 - Suportar ≥ 50 utilizadores simultaneos por empresa sem degradacao.
...
- `guia_path`: `docs/planificacao/guias-bk/MF6/BK-MF6-02.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF09` associado a `Suportar ≥ 50 utilizadores simultaneos por empresa sem degradacao.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Suportar ≥ 50 utilizadores simultaneos por empresa sem degradacao.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF09` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF09) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF6-02`.
