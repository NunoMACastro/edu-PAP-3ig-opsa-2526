# BK-MF6-07 - Passwords devem usar bcrypt com salt seguro.
...
- `guia_path`: `docs/planificacao/guias-bk/MF6/BK-MF6-07.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF14` associado a `Passwords devem usar bcrypt com salt seguro.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Passwords devem usar bcrypt com salt seguro.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF14` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF14) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF6-07`.
