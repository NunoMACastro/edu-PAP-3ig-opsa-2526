# BK-MF6-04 - Calculo de custo (FIFO) deve ser incremental e nao bloquear operacoes.
...
- `guia_path`: `docs/planificacao/guias-bk/MF6/BK-MF6-04.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF11` associado a `Calculo de custo (FIFO) deve ser incremental e nao bloquear operacoes.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Calculo de custo (FIFO) deve ser incremental e nao bloquear operacoes.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF11` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF11) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF6-04`.
