# BK-MF6-01 - Insercao de documentos (fatura, compra, lancamento) deve ser ≤ 1 segundo.
...
- `guia_path`: `docs/planificacao/guias-bk/MF6/BK-MF6-01.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF08` associado a `Insercao de documentos (fatura, compra, lancamento) deve ser ≤ 1 segundo.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Insercao de documentos (fatura, compra, lancamento) deve ser ≤ 1 segundo.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF08` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF08) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF6-01`.
