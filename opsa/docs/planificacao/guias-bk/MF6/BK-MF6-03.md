# BK-MF6-03 - Reconciliacao bancaria deve sugerir correspondencias em ≤ 3 segundos.
...
- `guia_path`: `docs/planificacao/guias-bk/MF6/BK-MF6-03.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF10` associado a `Reconciliacao bancaria deve sugerir correspondencias em ≤ 3 segundos.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Reconciliacao bancaria deve sugerir correspondencias em ≤ 3 segundos.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF10` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF10) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF6-03`.
