# BK-MF6-10 - Chaves de API e credenciais apenas em variaveis de ambiente.
...
- `guia_path`: `docs/planificacao/guias-bk/MF6/BK-MF6-10.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RNF17` associado a `Chaves de API e credenciais apenas em variaveis de ambiente.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Chaves de API e credenciais apenas em variaveis de ambiente.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RNF17` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RNF17) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF6-10`.
