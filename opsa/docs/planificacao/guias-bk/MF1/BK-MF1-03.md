...
- `guia_path`: `docs/planificacao/guias-bk/MF1/BK-MF1-03.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF15` associado a `Registar recebimentos (parciais/totais).`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Registar recebimentos (parciais/totais).` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF15` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF15) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF1-03`.
