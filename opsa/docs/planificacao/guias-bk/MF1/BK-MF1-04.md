...
- `guia_path`: `docs/planificacao/guias-bk/MF1/BK-MF1-04.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF16` associado a `Gerar lancamentos contabilisticos automaticos por venda.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Gerar lancamentos contabilisticos automaticos por venda.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF16` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF16) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF1-04`.
