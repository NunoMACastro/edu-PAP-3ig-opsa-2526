# BK-MF1-08 - Registar historico de decisoes de aprovacao e comentarios.
...
- `guia_path`: `docs/planificacao/guias-bk/MF1/BK-MF1-08.md`
- `last_updated`: `2026-04-13`

## O que vamos fazer neste BK
Implementar e documentar o requisito `RF20` associado a `Registar historico de decisoes de aprovacao e comentarios.`, com entrega verificavel e rastreabilidade 1:1 entre backlog, matriz e guia.
...
- Impacto funcional: `Registar historico de decisoes de aprovacao e comentarios.` desbloqueia valor direto no produto OPSA.
...
- O requisito `RF20` e demonstrado em cenario real de utilizacao.
...
1. Ler `RF/RNF` do BK (RF20) e confirmar contexto tecnico antes de tocar no codigo.
...
4. Mapear onde alterar no projeto (frontend/backend/dados/integracao) para o BK `BK-MF1-08`.
