...
import { buildTrialBalanceForExport } from "../accounting-reports/accountingReportService.js";

/**
 * Soma valores numéricos de uma coleção para agregações financeiras.
 *
 * @param rows - Linhas de dados a processar.
 * @param mapper - Função que extrai o valor numérico a somar.
 * @returns Soma numérica calculada para o campo indicado.
 */
...
export async function buildIncomeStatement(prisma, input) {
    const trialBalance = await buildTrialBalanceForExport(prisma, input);
