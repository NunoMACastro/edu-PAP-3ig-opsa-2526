 ...
 * @returns {Promise<object[]>} Documentos de compra.
 */
export async function listPurchaseDocuments(prisma, companyId) {
...
export async function createPurchaseDocument(prisma, companyId, userId, input) {
    ...
    if (dueDate && Number.isNaN(dueDate.getTime())) {
        throw httpError(400, "INVALID_DUE_DATE", "Data de vencimento inválida");
    }
