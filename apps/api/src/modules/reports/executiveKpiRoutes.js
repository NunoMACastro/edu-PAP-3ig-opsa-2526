...
/**
 * Constrói o router dos KPIs executivos.
 * Protege a consulta e delega a validação do intervalo antes de calcular indicadores de gestão.
 *
...
export function buildExecutiveKpiRoutes({ prisma }) {
    ...
    const guards = [
        ...
        requirePermission(Permission.EXECUTIVE_KPIS_READ),
    ];
