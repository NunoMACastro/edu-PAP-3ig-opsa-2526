...
const reservedAutomaticSourceTypes = new Set([
    "SALE_DOCUMENT_LINE",
...
export function parseStockMovement(input) {
    ...
    if ((sourceType === null) !== (sourceId === null)) {
        throw httpError(
            ...
            "A origem exige tipo e identificador em conjunto",
        );
    }
    if (reservedAutomaticSourceTypes.has(sourceType)) {
        throw httpError(
            400,
            "RESERVED_STOCK_SOURCE",
            "A origem indicada é reservada a movimentos automáticos",
        );
    }
