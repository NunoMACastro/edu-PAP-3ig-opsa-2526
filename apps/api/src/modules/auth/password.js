...
export async function hashPassword(password) {
    // Defesa em profundidade: services internos também não podem contornar a
    // fronteira de 72 bytes imposta nos payloads de registo e recuperação.
    return bcrypt.hash(validateNewPasswordPolicy(password), BCRYPT_ROUNDS);
}
