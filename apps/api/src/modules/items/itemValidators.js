...
/**
 * Valida um campo textual obrigatório de artigo ou serviço.
 * O nome funcional do campo entra na mensagem para o utilizador perceber o erro.
 *
...
/**
 * Valida unidade SAF-T apenas quando explicitamente fornecida.
 *
 * @param {unknown} value - Unidade ou null.
 * @returns {string | null} Unidade normalizada.
 */
function optionalUnitOfMeasure(value) {
    ...
    if (
        ...
        throw httpError(400, "INVALID_UNIT_OF_MEASURE", "unitOfMeasure é inválida");
    }
    return value.trim();
}
...
export function validateItemPayload(body) {
    ...
    if (Object.hasOwn(body, "unitOfMeasure")) {
        result.unitOfMeasure = optionalUnitOfMeasure(body.unitOfMeasure);
    }
    return result;
}
