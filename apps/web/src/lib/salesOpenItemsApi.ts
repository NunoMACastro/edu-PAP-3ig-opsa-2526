...
import { apiClient, type CursorPagination } from "./apiClient";
...
export const salesOpenItemsApi = {
   ...
   */
  list: (asOfDate?: string, pagination: CursorPagination = {}) =>
    apiClient.sales.listOpenItems(asOfDate, pagination),
};
