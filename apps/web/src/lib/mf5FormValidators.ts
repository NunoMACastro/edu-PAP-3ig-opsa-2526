 ...
 * @returns Não devolve valor; altera a lista recebida quando existe erro.
 */
 ...
 * @returns Não devolve valor; lança erro quando existe validação inválida.
 */
 ...
 * @returns Não devolve valor; lança erro quando o FormData contém campos inválidos.
 */
