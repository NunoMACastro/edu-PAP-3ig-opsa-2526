...
assertContract(app, /formErrors\.applyErrors/, "OperationForm associa validacao local aos campos");
assertContract(app, /aria-invalid/, "OperationForm expõe estado inválido acessível");
assertContract(app, /FormErrorSummary/, "OperationForm resume erros antes da API");
