...
assertContract(component, /data-label=\{column\.label\}/, "rotulo de celula preservado");
assertContract(component, /export interface ResourceColumn/, "schema explícito de colunas");
assertContract(component, /\.slice\(0, 5\)/, "limite mobile de campos prioritários");
...
assertContract(app, /function DataTable\(\{[\s\S]*resourceId,[\s\S]*emptyState,/, "assinatura de DataTable");
assertContract(app, /RESOURCE_COLUMNS/, "schemas PT-PT por recurso");
