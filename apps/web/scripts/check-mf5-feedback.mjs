...
assertContract(mf4, /Sugest(?:o|õ)es atualizadas\./, "MF4 sugestoes confirmam sucesso");
assertContract(mf4, /Resposta gerada com sucesso\./, "MF4 perguntas confirmam sucesso");
// O fluxo assíncrono de alertas QUEUED -> COMPLETED é coberto em SmartAlertsPage.test.tsx.
