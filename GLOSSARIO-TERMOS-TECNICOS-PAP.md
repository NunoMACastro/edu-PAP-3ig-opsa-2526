# Glossario de Termos Tecnicos - PAP (Projeto OPSA)

Objetivo: explicar termos tecnicos da documentacao e da planificacao sem linguagem complicada.

## 0) Termos especificos do OPSA

### SNC (Sistema de Normalizacao Contabilistica)

- O que e: referencial contabilistico usado em Portugal.
- No projeto: orienta plano de contas, lancamentos e mapas financeiros.

### SAF-T (PT)

- O que e: ficheiro normalizado para exportacao fiscal/contabilistica.
- No projeto: obriga validacao de estrutura e consistencia dos dados exportados.

### Reconciliacao bancaria

- O que e: comparar movimentos internos com extratos bancarios.
- No projeto: reduz erros de tesouraria e melhora fiabilidade de saldos.

### Balancete e Razao

- O que e: relatorios nucleares da contabilidade geral.
- No projeto: servem de base para controlo financeiro e auditoria interna.

### Centros de custo

- O que e: forma de segmentar custos/receitas por area ou projeto.
- No projeto: permite analise de margem e desempenho por segmento.

### PMR/PMP/EBITDA

- O que e: indicadores de performance financeira e operacional.
- No projeto: alimentam dashboards e apoio a decisao do gestor.
